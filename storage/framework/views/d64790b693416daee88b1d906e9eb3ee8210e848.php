...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.class_report'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.reports'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.class_report'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30 mt-30"><?php echo app('translator')->getFromJson('lang.class_report_for_class'); ?> <?php echo e($class->class_name); ?> <?php echo e($section != ""? 'section ('. $section->section_name.')': ''); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="student-meta-box mb-40">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="value text-left text-uppercase">
                                        <?php echo app('translator')->getFromJson('lang.class'); ?> <?php echo app('translator')->getFromJson('lang.information'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="value text-left text-uppercase">
                                        <?php echo app('translator')->getFromJson('lang.quantity'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="name text-left">
                                        <?php echo app('translator')->getFromJson('lang.number_of_student'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="name text-left">
                        ...
                        <div class="single-meta">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="name text-left">
                                        <?php echo app('translator')->getFromJson('lang.total_subjects_assigned'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="name text-left">
                    ...
                    <div class="student-meta-box mb-40">
                        <div class="single-meta">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="value text-left text-uppercase">
                                        <?php echo app('translator')->getFromJson('lang.information'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                <?php echo app('translator')->getFromJson('lang.collection'); ?>(<?php echo e($currency); ?>)
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="value text-left text-uppercase">
                                                <?php echo app('translator')->getFromJson('lang.due'); ?>(<?php echo e($currency); ?>)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="name text-left">
                                                <?php echo e(number_format($total_assign - $total_collection, 2)); ?><input type="hidden" id="total_assign" name="total_assign" value="<?php echo e($total_assign); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="value text-left text-uppercase bb-15 pb-7">
                                                <?php echo app('translator')->getFromJson('lang.fees_details'); ?>
                                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gehlotclasses/public_html/ims.gehlotclasses.com/resources/views/backEnd/reports/class_report.blade.php ENDPATH**/ ?>