                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12 d-flex mb-20">
                                            <div class="row">
                                                <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->getFromJson('lang.send_through'); ?></p>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/livedemopiehash/public_html/gehlot/resources/views/backEnd/communicate/sendEmailSms.blade.php ENDPATH**/ ?>