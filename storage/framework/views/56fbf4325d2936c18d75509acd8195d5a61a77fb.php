...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.result'); ?> <?php echo app('translator')->getFromJson('lang.archive'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.report'); ?></a>
                <a href="<?php echo e(url('results-archive')); ?>"><?php echo app('translator')->getFromJson('lang.result'); ?>  <?php echo app('translator')->getFromJson('lang.archive'); ?>  </a> 
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('criteria'); ?> </h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12"> 
                <div class="white-box">
                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'previous-class-results-view', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student'])); ?>
        ...
        <div class="row">
            ...
            <a target="_blank" href="<?php echo e(url('previous-class-results/print',$admission_number  )); ?>" class="primary-btn small fix-gr-bg "><span class="ti-printer pr-2"></span> <?php echo app('translator')->getFromJson('lang.print'); ?>  </a>  
            </div> 
        </div>
            <div class="row mt-20">
                <div class="col-lg-12">
                                ...
                                <div class="single-report-admit">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="white-box p-5"> 
                                                ...
                                                <div class="row  mt-40 ">
                                                    <div class="col-lg-12 transcript-heading">
                                                        <h2 class="text-center text-uppercase"> <?php echo app('translator')->getFromJson('lang.official'); ?> <?php echo app('translator')->getFromJson('lang.transcript'); ?> </h2>
                                                    </div>
                                                </div>
                                                <div class="row mt-20 transcript-heading">
                                                    <div class="col-lg-4">
                                                        <strong><?php echo app('translator')->getFromJson('lang.student_name'); ?>:</strong> <?php echo e($studentDetails->full_name); ?> <br>
                                                        ...
                                                        ?>
                                                        <strong><?php echo app('translator')->getFromJson('lang.mother_name'); ?>:</strong> <?php echo e($mother->mothers_name); ?><br>
                                                        <strong><?php echo app('translator')->getFromJson('lang.school_name'); ?>:</strong> <?php echo e(App\SmGeneralSettings::find(1)->school_name); ?><br>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <strong><?php echo app('translator')->getFromJson('lang.transcript'); ?> <?php echo app('translator')->getFromJson('lang.none'); ?>:</strong> <?php echo e($studentDetails->admission_number); ?><br>
                                                        <strong><?php echo app('translator')->getFromJson('lang.academic_year'); ?>: </strong> <?php echo e(App\YearCheck::getYear()); ?><br>
                                                        <strong><?php echo app('translator')->getFromJson('lang.admission_no'); ?>:</strong> <?php echo e($studentDetails->admission_number); ?><br>
                                                    </div>
                                                    
                                                    <div class="col-lg-4">
                                                        <strong><?php echo app('translator')->getFromJson('lang.class'); ?>:</strong> <?php echo e($current_class->class_name); ?><br>
                                                        <strong><?php echo app('translator')->getFromJson('lang.section'); ?> :</strong> <?php echo e($current_section->section_name); ?><br>
                                                        <strong><?php echo app('translator')->getFromJson('lang.date_of_birth'); ?>:</strong> <?php echo e($studentDetails->date_of_birth != ""? App\SmGeneralSettings::DateConvater($studentDetails->date_of_birth):''); ?>
                                            ...
                                            <div class="row  mt-40 ">
                                                    <div class="col-lg-3">
                                                        <strong><?php echo app('translator')->getFromJson('lang.exam_terms'); ?>:</strong> 
                                                        <?php
                                                    ...
                                                    <div class="col-lg-3">
                                                        <strong><?php echo app('translator')->getFromJson('lang.roll'); ?>:</strong> <?php echo e($studentDetails->previous_roll_number); ?>

                                                    </div>
                                                    <div class="col-lg-3">
                                                        <strong><?php echo app('translator')->getFromJson('lang.class'); ?>:</strong> 
                                                        <?php
                                                    ...
                                                    <div class="col-lg-3">
                                                        <strong><?php echo app('translator')->getFromJson('lang.date'); ?>:</strong>
                                                        <?php echo e($is_mark_available->created_at != ""? App\SmGeneralSettings::DateConvater($is_mark_available->created_at):''); ?>
                                    ...
                                    <table class="w-100  mt-10 mb-20 table table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        ...
                                                        <th rowspan="2"><?php echo app('translator')->getFromJson('lang.total'); ?></th>
                                                        <th rowspan="2"><?php echo app('translator')->getFromJson('lang.grade'); ?></th>
                                                        <th rowspan="2"><?php echo app('translator')->getFromJson('lang.gpa'); ?></th>
                                                    </tr>
                                                <tr  style="text-align: center;">
                                                    <?php $__currentLoopData = $assinged_exam_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assinged_exam_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <th><?php echo app('translator')->getFromJson('lang.marks'); ?></th>
                                                        <th><?php echo app('translator')->getFromJson('lang.grade'); ?></th>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="<?php echo e($colspan / 2 - 1); ?>" class="text-center"><?php echo app('translator')->getFromJson('lang.total'); ?> <?php echo app('translator')->getFromJson('lang.marks'); ?></td>
                                                        <td colspan="<?php echo e($colspan / 2 + 1); ?>" class="text-center"><?php echo e($total_marks); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="<?php echo e($colspan / 2 - 1); ?>" class="text-center"><?php echo app('translator')->getFromJson('lang.total'); ?> <?php echo app('translator')->getFromJson('lang.grade'); ?></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="<?php echo e($colspan / 2 - 1); ?>" class="text-center"><?php echo app('translator')->getFromJson('lang.total'); ?> <?php echo app('translator')->getFromJson('lang.gpa'); ?></td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gehlotclasses/public_html/ims.gehlotclasses.com/resources/views/backEnd/reports/previousClassResults.blade.php ENDPATH**/ ?>