...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.subject'); ?> <?php echo app('translator')->getFromJson('lang.wise'); ?> <?php echo app('translator')->getFromJson('lang.attendance'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.student_information'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.subject'); ?> <?php echo app('translator')->getFromJson('lang.wise'); ?> <?php echo app('translator')->getFromJson('lang.attendance'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?php endif; ?>
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'subject-attendance-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_studentA'])); ?>
...
<?php if(isset($already_assigned_students)): ?>
 ...
 <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
            ...
            <?php if(in_array(534, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
            ...
            <?php endif; ?>
                    ...
                    <!-- <div class="d-flex justify-content-between mb-20"> -->
                        <!-- <button type="submit" class="primary-btn fix-gr-bg mr-20" onclick="javascript: form.action='<?php echo e(url('student-attendance-holiday')); ?>'">
                            ...
                            <?php echo app('translator')->getFromJson('lang.mark_as_holiday'); ?>
                        </button> -->
                        ...
                        <div class="col-lg-12">
                            <table id="table_id_table" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <?php endif; ?>
                                    <tr>
                                        <th width="5%"><?php echo app('translator')->getFromJson('lang.sl'); ?></th>
                                        <th width="10%"><?php echo app('translator')->getFromJson('lang.admission'); ?> <?php echo app('translator')->getFromJson('lang.no'); ?></th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gehlotclasses/public_html/ims.gehlotclasses.com/resources/views/backEnd/studentInformation/subject_attendance.blade.php ENDPATH**/ ?>