        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="http://gehlot.piehash.online/public/frontend/images/banner-july-1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="http://gehlot.piehash.online/public/frontend/images/July-banner-3.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="http://gehlot.piehash.online/public/frontend/images/gehlot-classes-topper.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <section class="px-md-5 px-0 section-gap">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <!--    <div class="course-card my-3 p-sm-4 px-0">-->
                <!--        <div class="course-icon">-->
                <!--            <img src="http://gehlot.piehash.online/public/frontend//images/icon-2.png">-->
                <!--        </div>-->
                <!--        <div class="course-text text-center">-->
                ...
                <!--    <div class="course-card my-3 p-sm-4 px-0">-->
                <!--        <div class="course-icon">-->
                <!--            <img src="http://gehlot.piehash.online/public/frontend/images/icon-1.png">-->
                <!--        </div>-->
                <!--        <div class="course-text text-center">-->
                    ...
                    <div class="news-list pl-md-4 pl-0 py-3 mb-3">
                        ...
                        <div class="notice-board">
                            ...
                            <div class="news-text">
                                ...
                                <h4>
                                    <a href="http://gehlot.piehash.online/news-details/11">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <div class="event-img" style="background-image:url(http://gehlot.piehash.online/public/uploads/news/news1.jpg)"></div>
                     ...
                     <?php $__currentLoopData = $testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-testimonial">
                            <div class="testimonial-img">
                                <img src="http://gehlot.piehash.online/public/frontend/images/testimonial-image.jpg">
                            </div>
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/livedemopiehash/public_html/gehlot/resources/views/frontEnd/home/light_home.blade.php ENDPATH**/ ?>